...
reply=1
while reply == 1 :
    print("법정동 코드를 찾기 위해 시도명과 시군구명, 읍면동을 입력해주세요")
    ...
    conn = sqlite3.connect("C:\\Users\\jin\\Desktop\\project_db\\house_db.db")
    cursor = conn.cursor()
    conn.commit()
    ...
    PNU=region_code*1000000000+100000000+main_address*10000+sub_address
    ...
    reply=int(input("종료하시려면 0, 더 알아보시려면 1을 입력해주세요"))